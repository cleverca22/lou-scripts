...
qx.Class.define("paTweak.Version", {
    ...
    statics:{
		PAversion:"3.1",
		PAbuild:"Sun Oct 28 21:39:13 GMT 2012",
        PAcodename:"",
...
qx.Class.define("paTweak.Main", {
    ...
    members:{
        ...
        tweakPA:function () {
            ...
            this.cCmdInfoView.commandHeaderData.header.add(this.cancelOrders, {left:155, top:7});
            ...
            try {
                ...
                //DISABLED row.add(askBotxHistoryBtn, {flex:1});
                ...
                //DISABLED row.add(askBotxCityBtn, {flex:1});
        ...
        createRaidApplyToAll: function () {
            ...
            orderPage.applyAllBtn.set( {marginRight:4,marginLeft:9} );
            ...
            members: {
              ...
              showMessageWindow: function()
              {
                if( this._msgWin == null )
                {
                  ...
                  */
                  win.addListener( "close", function(){ this._msgWin = null; }, this );
                  win.center();
                  win.open();
                  this._msgWin = win;
                }
...
*/
          ...
          createIdleUnitsPage: function()
          {
            ...
            container.setLayout( new qx.ui.layout.HBox );
         	...
         	this.cityGroups = new qx.ui.form.SelectBox().set( {width:50,alignY:"middle",tabIndex:1} );
          ...
          {
          	console.log("Execute button: " + this.getLabel())
          },
...
/*
  ...
  */  
            ...
            pvpPage.add( this.pvpTable, {flex:1} );

            this.pvpTroopContainer = new qx.ui.container.Composite();
            this.pvpTroopContainer.setLayout( new qx.ui.layout.HBox().set( {spacing:4} ) );
          ...
          createDungeonPage: function()
          {
            ...
            this.departOptions = new qx.ui.form.SelectBox().set( {width:88,alignY:"middle",tabIndex:6} );
            ...
            this.nextIdleCityButton=new webfrontend.ui.SoundButton(null,"webfrontend/theme/scrollbar/scrollbar-right.png").set( { paddingLeft: 8, paddingRight: 8, paddingTop: 2, paddingBottom: 2, marginLeft: 15, marginRight: 15, alignY:"center", enabled:false, toolTipText: "Next idle city"} );
...
qx.Class.define("paTweak.ui.components.AttackOrder", {
    ...
    members:{
        ...
        buildUI:function () {
            ...
            this._coordsText.set({width:60, marginTop:1, maxLength:40, toolTipText:"Coordinates in xxx:yyy format."});
            ...
            this.centerViewBtn.set({width: 20, appearance: "button-text-small", toolTipText: "Go to city"});
            ...
            this._noteText.set({width:210, toolTipText:"Just a note."});
...
qx.Class.define("paTweak.ui.components.LeftPanel", {
    ...
    members:{
        ...
        buildPanelUI:function (labelText) {
            ...
            this.add(this.showIncomingAttacksBtn,{top:6,left:146});
            ...
            this.add(this.showCombatButtonBtn,{top:6,left:206});
            ...
            this.add(this.showRaidButtonBtn,{top:6,left:126});
            ...
            this.add(this.showPalaceItemsBtn,{top:6,left:166});
        },
        _mg:function() {
...
*/
            // Cancel Raids
            this._cancelRaidsSelect = new qx.ui.form.SelectBox().set({width:80,maxWidth:80,toolTipText:"Cancel all raid orders or alter to return in the specified number of hours.", paddingTop:0,paddingBottom:0});
            ...
            this._cancelRaidsButton.set({width:23, maxWidth:23, appearance:"button-text-small", toolTipText:"Apply to raid orders."});
        ...
        cancelAllRaids:function () {
            ...
            //{"session":"9c9a31f6-b3ce-42a5-8ed3-428804d7925f","cityid":3211595,"id":4710984,"isDelayed":false,"recurringType":1,"recurringEndStep":8522010}
              ...
              var commandManager = webfrontend.net.CommandManager.getInstance();
                  ...
                  }, this, function (error) { this._setButtonsEnabled(true); if (error) { paDebug(error); } });
							  }
						  }
            }
            else
...
m=checkTime(m);
s=checkTime(s);
console.log(hI.getFullYear() + '/' + (hI.getMonth() + 1) + '/' + hI.getDate() + ' ' + h+':'+m+':'+s);
/*
console.log(hI);
hI.setTime(hI.getTime() + (hrs*60*60*1000));
var h=hI.getHours();
var m=hI.getMinutes();
var s=hI.getSeconds();
h=checkTime(h);
m=checkTime(m);
s=checkTime(s);
console.log(dte.getFullYear() + '/' + (hI.getMonth() + 1) + '/' + hI.getDate() + ' ' + h+':'+m+':'+s);
console.log(hI);
*/
          return hI.getTime();
        }
...
qx.Class.define("paTweak.ui.CombatWindow", {
    ...
    members:{
        ...
        buildUI:function () {
            this.setLayout(new qx.ui.layout.VBox(5));
            this.set({allowMaximize:false, allowMinimize:false, showMaximize:false, showMinimize:false,
                showStatusbar:false, showClose:false, contentPadding:5, useMoveFrame:true, resizable:false, minWidth: 545});
            ...
            this.scrollContainer = new qx.ui.container.Scroll().set({width: 510, height: 0});
		        this.scrollContainer.setMaxHeight(300);
		        this.scrollContainer.setMinHeight(0);
