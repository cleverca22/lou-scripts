  ...
  var LoUBBCode, main = function () {
      ...
      var startup = function () {
            if (checkDependencies() === 1) {
              ...
              window.setTimeout(qx.event.GlobalError.observeMethod(startup), 2000);
            }
        };
      window.setTimeout(qx.event.GlobalError.observeMethod(startup), 1000);
    };
